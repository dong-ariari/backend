...
public class QMember extends EntityPathBase<Member> {
    ...
    public final ListPath<youngpeople.aliali.entity.Apply, youngpeople.aliali.entity.QApply> applies = this.<youngpeople.aliali.entity.Apply, youngpeople.aliali.entity.QApply>createList("applies", youngpeople.aliali.entity.Apply.class, youngpeople.aliali.entity.QApply.class, PathInits.DIRECT2);
